...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs['magellan-expedition'] = {
    ...
    settings : {
      ...
      fixed_top: 40, // top distance in pixels assigend to the fixed element on scroll
      ...
      $('[' + this.attr_name() + ']', self.scope).each(function() {
        ...
        offsets.each(function(idx, item) {
          if (item.viewport_offset >= item.top_offset) {
            ...
            $("dl.sub-nav dl dd").siblings().andSelf().css('display', 'none');
            $("dl.sub-nav dd.active dd").css('display', 'block');
            $("dl.sub-nav dl dd.active").siblings().andSelf().css('display', 'block');
            active_item = true;
            return true;
          }
        });
